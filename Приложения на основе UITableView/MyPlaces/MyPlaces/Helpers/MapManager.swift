...
//  MyPlaces
//
//  Created by Victor Kimpel on 30.03.23.
//
...
class MapManager {
    ...
    // Проверка авторизации приложения для использования серсисов геолокации
    ...
    // Меняем отображаемую зону области карты в соответствии с перемещением пользавателя
